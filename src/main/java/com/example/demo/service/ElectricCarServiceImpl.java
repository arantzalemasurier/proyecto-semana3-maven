...
public class ElectricCarServiceImpl implements ElectricCarService {
	...
	static {
		...
		ElectricCar car1 = new ElectricCar(1L, "Seat", "León", "blanco", 4, new Battery(1L, 14D),
				new AirConditioning(1L, 24F), new ElectricMotor(1L, 150F, 400F), new ElectricPlug(1L, PlugType.TYPE1));

		ElectricCar car2 = new ElectricCar(2L, "BMW", "X3i", "negro", 2, new Battery(1L, 18D),
				new AirConditioning(1L, 22F), new ElectricMotor(1L, 180F, 400F), new ElectricPlug(1L, PlugType.TYPE2));
		car2.getMotor().start();

		ElectricCar car3 = new ElectricCar(3L, "Skoda", "Octavia", "marrón", 4, new Battery(1L, 18D),
				new AirConditioning(1L, 20F), new ElectricMotor(1L, 150F, 400F), new ElectricPlug(1L, PlugType.CCS));
