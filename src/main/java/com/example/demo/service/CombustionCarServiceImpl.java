...
public class CombustionCarServiceImpl implements CombustionCarService{
    ...
    static{ 
		...
		CombustionCar car1 = new CombustionCar(1L, "Seat", "Ibiza", "rojo", 2, 
				new Battery(1L, 14D),
				new AirConditioning(1L, 24F),
				new CombustionMotor(1L, 150F, FuelType.PETROL, 1000F ),
				new Tank(1L, 60D));
		
		CombustionCar car2 = new CombustionCar(2L, "Audi", "A3", "negro", 4,
				new Battery(1L, 16D),
				new AirConditioning(1L, 26F),
				new CombustionMotor(1L, 180F, FuelType.DIESEL, 1000F ),
				new Tank(1L, 80D));
		car2.getMotor().start();
		
		CombustionCar car3 = new CombustionCar(3L, "Toyota", "Auris", "blanco", 4,
				new Battery(1L, 16D),
				new AirConditioning(1L, 26F),
				new CombustionMotor(1L, 180F, FuelType.DIESEL, 1000F ),
				new Tank(1L, 80D));
