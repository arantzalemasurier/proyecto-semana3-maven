...
public class HybridCarServiceImpl implements HybridCarService{
    ...
    static{ 
		...
		HybridCar car1 = new HybridCar(1L, "Alfa", "Romeo", "gris", 4,
				new Battery(1L, 14D),
				new AirConditioning(1L, 24F),
				new HybridMotor(1L, 150F),
				new HydrogenTank(1L, 80D));
		
		HybridCar car2 = new HybridCar(2L, "Hyundai", "i30", "verde", 4,
				new Battery(1L, 14D),
				new AirConditioning(1L, 19F),
				new HybridMotor(1L, 160F),
				new HydrogenTank(1L, 70D));
		car2.getMotor().start();
		
		HybridCar car3 = new HybridCar(3L, "Volkswagen", "Golf", "gold", 4,
				new Battery(1L, 14D),
				new AirConditioning(1L, 19F),
				new HybridMotor(1L, 160F),
				new HydrogenTank(1L, 70D));
    ...
    public List<HybridCar> findByColor(String color) {
    	List<HybridCar> results = new ArrayList<HybridCar>();
