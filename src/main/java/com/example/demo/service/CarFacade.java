...
public class CarFacade {
	...
	public static Car createCombustionCar() {
		...
		CombustionCar car = new CombustionCar(1L, "Default brand3", "Default model", "Default color", 4, battery, air, motor, tank);
		car.getMotor().start();
		car.getAir().start();
	...
	public static Car createElectricCar() {
		...
		ElectricCar car = new ElectricCar(1L, "Default brand1", "Default model", "Default color", 4, battery, air, motor, plug);
		car.getMotor().start();
		car.getAir().start();
	...
	public static Car createHybridCar() {
		...
		HybridCar car = new HybridCar(1L, "Default brand2", "Default model", "Default color", 4, battery, air, motor, tank);
		car.getMotor().start();
		car.getAir().start();
