...
class CarFacadeTest {
	...
	void testCombustionCar() {
		...
		assertEquals(car.toString(),"Car [id=1, brand=Default brand combustion, model=Default model, color=Default color, door=4"
	...
	void testElectriCar() {
		...
		assertEquals(car.toString(),"Car [id=1, brand=Default brand electric, model=Default model, color=Default color, door=4"
				+ ", battery=Battery [id=1, capacity=14.0]"
				+ ", air=AirConditioning [id=1, on=true, temperature=24.0]"
	...
	void testHybridCar() {
		...
		assertEquals(car.toString(),"Car [id=1, brand=Default brand hybrid, model=Default model, color=Default color, door=4"
				+ ", battery=Battery [id=1, capacity=14.0]"
				+ ", air=AirConditioning [id=1, on=true, temperature=24.0]"
